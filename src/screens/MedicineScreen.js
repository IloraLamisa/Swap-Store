...
import {
  getMedicineProducts,
  getMedicineOnSaleProducts,
} from '../../assets/data/Products';

export default function MedicineScreen({ navigation }) {
  const allMedicine = useMemo(() => getMedicineProducts(), []);
  const onSaleMedicine = useMemo(() => getMedicineOnSaleProducts(), []);
